...
const Equipe = () => {
  ...
  return (
    <>
      ...
      <div className="croco ">
      <h1 className="text-white pt-10  font ml-10 text-6xl text-center">THE TEAM</h1>
      ...
      <section className=" grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto px-5   bg-black  ">
        {equipes.map((equipe) => (
...
<p className="text-2xl pb-10">{equipe.lastname}</p>
                    </div>
                    {equipe.drapo && (
                      <img
